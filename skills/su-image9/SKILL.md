  ...
  "pages": [
    {
      ...
      "panels": [
        ...
        { "panel_no": 2, "shot_nos": [2] },
        { "panel_no": 3, "shot_nos": [3] },
        { "panel_no": 4, "shot_nos": [4] },
        { "panel_no": 5, "shot_nos": [5] },
        { "panel_no": 6, "shot_nos": [6] },
        { "panel_no": 7, "shot_nos": [7] },
        { "panel_no": 8, "shot_nos": [8] },
        { "panel_no": 9, "shot_nos": [9] }
      ]
    }
  ]
}
...
只有用户明确要求生图或 ZIP 时才生图。每段提示词生成一张独立 3x3 九宫格 PNG，PNG 放入 `pages/`，与 `prompts.md`、`page-map.json` 一起作为后处理输入。
