  ...
  "pages": [
    {
      ...
      "page_split_policy": "scene_layer_aware_strict_source_order | +intentional_cross_scene_bridge | +intentional_layer_bridge",
      "source_scene_ids": ["S01"],
      "source_layer_keys": ["current"],
      "split_reason": "max_page_size_reached | semantic_split_to_protect_page_anchor_or_scene_layer_boundary | same_page_bridge_declared_by_page_split_policy",
      "anchor_decision": "human_confirmed | deterministic_source_order | omitted when deterministic",
      "panels": [
        {
          "panel": "PANEL-1",
          "source_shot": 1,
  ...
  "pages": [
    {
      ...
      "source": "PAGE-01.png",
      "header": "场景｜镜头001-008",
      "source_shot_range": "1-8",
      "sparse_page": true,
      "page_split_policy": "scene_layer_aware_strict_source_order",
      "split_reason": "semantic_split_to_protect_page_anchor_or_scene_layer_boundary",
      "panels": [
        {
          "panel_no": 1,
          "shot_nos": [1],
