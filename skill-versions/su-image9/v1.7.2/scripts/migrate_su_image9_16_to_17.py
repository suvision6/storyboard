#!/usr/bin/env python3
"""Migrate su-image9 1.6.x prompt artifacts toward the 1.7.2 contract."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Migrate su-image9 1.6.x panel plan and final prompts to 1.7.2 naming/canon markers.")
