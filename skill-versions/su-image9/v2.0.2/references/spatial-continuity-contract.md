...
正式派生脚本必须按连续空间、人物关系轴线、车辆内外连续关系、当前/回忆/手术现实/黑屏等叙事层级切页，不得固定每 9 镜头硬切。回忆层、手术现实层、黑屏镜头不得作为页首锚定格；终局慢动作或倒计时镜头只有在其本身是该段主空间建立镜头时才可开页。若同页跨同空间当前层场景或跨叙事层级，`panel_plan.json` 必须通过 `page_split_policy` 显式声明 bridge。
